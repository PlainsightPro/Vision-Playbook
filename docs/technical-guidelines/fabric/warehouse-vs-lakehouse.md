...
## Related Pages
- [3. Lakehouse Architecture](lakehouse-architecture.md) - Deep dive into medallion design patterns
- [6. Capacity Management](capacity-management.md) - Optimize Fabric capacity for both platforms
- [2. Workspace Organization](workspace-organization.md) - Structure teams and permissions
- [4. Data Pipeline Patterns](data-pipeline-patterns.md) - Design data flows for either platform