# Images for Fabric Best-Practices
...
2. Update markdown pages to reference the local image using standard markdown: `![alt](images/medallion_architecture.png)`.
...
License note: LinkedIn-hosted images may be subject to the author's copyright and LinkedIn's terms. Review usage rights before redistributing or publishing these images outside your organization.
