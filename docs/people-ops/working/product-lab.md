---
description: "Product Lab helps Plainsight colleagues turn scalable ideas into validated products with commercial, technical, and financial support."
---
...
```mermaid
flowchart TD
    A[Scalable idea] --> B[Sales reality check<br/>Will it sell?]
    B -->|No fit| C[Stop early and learn]
    B -->|Fit| D[Technical support<br/>and development]
    D --> E[Product pitch<br/>to customers]
    E --> F[Validate market fit]
    F -->|Not yet| G[Iterate and test again]
    G --> D
    F -->|Yes| H[Tiered investment]
    H --> I[New company or organization]

    classDef highlight fill:#F59E0B,stroke:#B45309,stroke-width:2px,color:#111827;
    classDef success fill:#60A5FA,stroke:#1D4ED8,stroke-width:2px,color:#111827;
    class A,B,H highlight;
    class D,E,F,G,I success;
```
...
```mermaid
pie showData
    title Equity Split After Market Fit
    "Founder" : 60
    "Plainsight" : 40
```
