---
description: "Wellbeing and prevention at Plainsight: who to contact, first aid, what to do after an accident or when you are ill, working from home, working at a client, psychosocial support and how we keep improving."
---
...
flowchart LR
    A[Accident] --> B[Get help / First aid or 112]
    B --> C[Inform HR and client]
    C --> D[See a doctor]
    D --> E[HR reports to AG Insurance / within 8 days]
    E --> F[Review together / prevent repeat]
```
...
[![Share an idea](https://img.shields.io/badge/Share_an_idea-Mail_HR-blue?style=for-the-badge)](mailto:hr@plainsight.pro?subject=Idea%20wellbeing%20%26%20prevention)
